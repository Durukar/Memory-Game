...
const checkEndGame = () => {
    ...
    if (disabledCards.length === 20) {
        ...
        alert(`Parabénsa, ${spanPlayer.innerHTML} você conseguiu! Seu tempo foi de ${timer.innerHTML}!!!`);
    }
}
...
const checkCards = () => {
    ...
    if (firstCharacter === secondCharacter) {
        ...
        firstCard = '';
        secondCard = '';
        const currentPlay = +jogadas.innerHTML;
        jogadas.innerHTML = currentPlay + 1;
